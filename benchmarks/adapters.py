...
from .registry import load_benchmark_configs, make_benchmark_option_id, parse_dimension_id
            ...
            for dim in cat.get('dimensions') or []:
                ...
                for idx, bench in enumerate(rows):
                    ...
                    index[option_id] = {
                        ...
                        'category': cat,
                        'benchmark': bench,
                        'execution': bench.get('execution') or dim.get('execution') or cfg.get('execution') or {},
...
def build_eval_command(
    ...
    _append_arg(cmd, str(arg_map.get('mitigation') or ''), payload.get('mitigation'))
